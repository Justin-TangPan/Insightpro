...
> AI 驱动的技术解决方案洞察与决策工作台 · `v0.8.8`

[![Version](https://img.shields.io/badge/version-0.8.8-176b46)](https://github.com/Justin-TangPan/Insightpro)
...
`v0.8.8` 修复了 AI 填充经前端代理约 30 秒断开的问题；InsightPro 仍是唯一账号、业务系统和写入边界。
