...
app = FastAPI(title="InsightPro API", version=settings.APP_VERSION, lifespan=lifespan)
...
@app.get("/")
async def root():
    return {"message": "InsightPro API is running", "version": settings.APP_VERSION}
