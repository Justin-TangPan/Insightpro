...
> AI 驱动的技术解决方案洞察与决策工作台 · `v0.8.15`

[![Version](https://img.shields.io/badge/version-0.8.15-176b46)](https://github.com/Justin-TangPan/Insightpro)
...
`v0.8.15` 修复 AI 流式请求与 Token 用量统计；InsightPro 仍是唯一账号、业务系统和写入边界。
